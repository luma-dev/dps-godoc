" Brought from https://github.com/mattn/vim-godoc under the MIT License.
...
function! go#complete#PackageMembers(package, member)
  silent! let content = system(dps#godoc#internal#get_godoc_executable(), dps#godoc#internal#get_godoc_args(a:package))
